    ...
    <div className="mx-auto w-full max-w-screen-xl">
      <div className="grid grid-cols-2 gap-2 px-4 py-6 lg:py-8 md:grid-cols-4">
        ...
        <h2 className="mb-6  dark:text-white">
          <span className='text-xl font-semibold text-blue-700 border-b-4 border-blue-800 uppercase'>
            Cụm Rạp Beta
          </span>
          </h2>
            <ul className="text-gray-500 dark:text-gray-400 font-normal">
                <li className="mb-4">
                    <a href="#" className="hover:underline">Beta Cinemas Lào Cai - Khai trương 5/2/2024 - Hotline 0358 968 970</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="hover:underline">Beta Cinemas TRMall Phú Quốc, Kiên Giang - Hotline 0983 474 440</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="hover:underline"> Beta Cinemas Empire Bình Dương - Hotline 0934 573 748</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="hover:underline">Beta Cinemas Quang Trung, TP Hồ Chí Minh - Hotline 0369 465 730</a>
                </li>
            </ul>
        </div>
        <div>
...
<br />
<br />
Địa chỉ trụ sở: Tầng 3, số 595, đường Giải Phóng, phường Giáp Bát, quận Hoàng Mai, thành phố Hà Nội
<br />
<br />
Hotline: 1900 636807
<br />
